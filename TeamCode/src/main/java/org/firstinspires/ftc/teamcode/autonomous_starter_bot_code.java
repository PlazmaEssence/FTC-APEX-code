...
@Autonomous(name="Robot: test", group="Robot")

public class autonomous_starter_bot_code extends LinearOpMode{
    ...
    public void runOpMode() {
        ...
        leftDrive.setPower(fDS);
        rightDrive.setPower(fDS);
        intakeMotor.setPower(fDS);
        servoLeft.setPower(fDS);
        servoRight.setPower(fDS);
